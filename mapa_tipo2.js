...
fetch("consulta_gra_areas_protegidas.php")
  ...
  .then(data => {
   ...
   // Cargar Minas
  fetch("consulta_gra_mensura_area.php")
    .then(res => res.json())
    .then(data => {
      ...
      overlayMaps["Mensura Área"] = capaMensuraArea;
      actualizarControlCapas();
    });

    // Cargar Minas
  fetch("consulta_gra_mensura_pertenencias.php")
    .then(res => res.json())
    .then(data => {
      ...
      overlayMaps["Mensura Pertenencias"] = capaMensuraPertenencias;
      actualizarControlCapas();
    });
