...
echo "<tr><th style='text-align: center;'>MANIFESTACION DE DESCUBRIMIENTO</th></tr>";
echo "</table><br>";
...
echo "<tr><th>EPOCA DE EXPLORACION:</th><td>".strtoupper($row['epoca_trab'])."</td></tr>";
...
echo "</td></tr>";            
echo "<tr><th>SUPERFICIE SOLICITADA:</th><td>".number_format($row['sup_decl_ha'], 2, '.', '')." ha</td></tr>";
...
echo "</table><br>";
        ...
        echo '<td>LEM</td>';
            ...
            $lem_result = pg_query_params($conn, $lem_sql, [$expediente]);
                ...
                echo '<td>'.htmlspecialchars(number_format($lem['e_pga07'], 2, ',', '')).'</td>';
                echo '<td>'.htmlspecialchars(number_format($lem['n_pga07'], 2, ',', '')).'</td>';
                                                            }
