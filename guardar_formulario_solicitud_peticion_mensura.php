...
// Obtener el sistema de coordenadas seleccionado por el usuario
$sistema_coordenadas = $_POST['sistema_coordenadas'] ?? 'posgar2007';
$srid_origen = ($sistema_coordenadas === 'posgar94') ? 22182 : 5344;
